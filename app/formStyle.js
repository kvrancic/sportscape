export const classAppearance = {
  ...
  className: {
    ...
    label: "text-red-500 py-2 mb-2 block w-full",
    input:
      "py-2 px-3 border text-gray-900 placeholder:text-gray-400 sm:text-sm sm:leading-6 rounded w-full mb-2",
    button:
      "w-full block bg-orange-500 border border-orange-700 hover:border-orange-400 hover:bg-blue-400 focus:bg-blue-400 text-white font-semibold rounded px-4 py-3 mt-6",
    message:
